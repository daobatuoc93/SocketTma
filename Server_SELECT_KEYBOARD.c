...
//============================================================================================
//Begin as usual with the includes and declarations and then initialize inputs to handle input
//from the keyboard:
...
int main()
{
    ...
    while (1)
    {
        ...
        // After this time, test result. If there has been no input, the program loops again. If there has
        ...
        case -1:
            perror("select");
            exit(1);
        // If, during the wait, you have some action on the file descriptor, read the input on stdin and
